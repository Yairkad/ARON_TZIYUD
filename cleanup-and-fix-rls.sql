-- Cleanup and fix RLS policies - Run this in Supabase SQL Editor
-- This will remove ALL existing policies and create new correct ones
...
CREATE POLICY "Block public modifications to equipment"
ON public.equipment FOR INSERT, UPDATE, DELETE
TO anon, authenticated
USING (false)
WITH CHECK (false);
...
CREATE POLICY "Block public modifications to borrow_history"
ON public.borrow_history FOR INSERT, UPDATE, DELETE
TO anon, authenticated
USING (false)
WITH CHECK (false);
